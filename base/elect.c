...
static const ElectMechaTaskPrep_t AutoAdjFCommands[]   = { // Test CD SCD-2700, DVD-SL HX-504, DVD-DL HX-505
    ...
    {21, MECHA_CMD_TAG_ELECT_DISC_DET_CDMIN_WR, 5000, MECHA_CMD_EEPROM_WRITE, "DISC DETECT EEPROM-CDmin WR", "00020321"}, // dont know whats that, seems depends on previous value
    {22, MECHA_CMD_TAG_ELECT_DISC_DET_DVDMAX_WR, 5000, MECHA_CMD_EEPROM_WRITE, "DISC DETECT EEPROM-DVDmax WR", "00050320"}, // dont know whats that, seems prev value - 1
